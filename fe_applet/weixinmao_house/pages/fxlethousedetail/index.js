...
var WxParse = require("../../resource/wxParse/wxParse.js"), QQMapWX = require("../../resource/js/qqmap-wx-jssdk.min.js"), app = getApp();
...
Page((_defineProperty(_Page = {
    ...
    onLoad: function(a) {
        ...
        var t = this, e = decodeURIComponent(a.scene).split("@"), i = parseInt(e[0]), s = parseInt(e[1]);
        t.data.tid = s, t.data.id = i, t.getlethousedetail();
    },
    gochat: function(a) {
        var t = wx.getStorageSync("userInfo"), e = a.detail.formId;
    ...
    toComplain: function() {
        var t = this.data.id, a = wx.getStorageSync("userInfo");
        app.util.request({
    ...
    markca: function(a) {
        console.log(222);
        var t = wx.getStorageSync("userInfo"), e = a.currentTarget.dataset.tel, i = (e = this.data.agentinfo.tel, 
        this.data.id);
        app.util.request({
            url: "entry/wxapp/Saveform",
            data: {
    ...
    saveuserinfo: function(a) {
        ...
        t.data.showmsg = !0;
        var s = wx.getStorageSync("userInfo"), o = t.data.id;
    ...
    var t = this, e = t.data.paytype, i = t.data.id, s = wx.getStorageSync("userInfo");
    if (0 == e) {
        wx.showModal({
            title: "确认支付",
            content: "确认支付？",
