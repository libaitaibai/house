...
Page({
    ...
    onLoad: function() {
        ...
        app.util.request({
            ...
            url:'entry/wxapp/getdevelopers',
            data:{},
            success:(e)=>{

               e.data.data.errno || (e.data.data.barTitle && wx.setNavigationBarTitle({
                    title: e.data.data.barTitle
                }));

               e.data.data.errno || (e.data.data.developers && this.setData({developers:e.data.data.developers}));
