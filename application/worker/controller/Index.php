...
use app\worker\model\Agent;
use tool\Crypt;
use app\worker\model\Worker;
class Index extends Base
{
    ...
    public function myInfo()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $dataForm = $db->where('id', session('Worker.id'))->field('password,build_page,build_client,build_admin,lock,lock_msg,username', true)->find();
            $this->succ(1, '', [
                'dataForm' => $dataForm,
                'apiData' => [
